...
class Character(object):
	...
	armour_selection = {
		'leather' : {'defence' : 0, 'agility-modifier' : 0, 'armour-quality' : 3},
		'chainmail' : {'defence' : 1, 'agility-modifier' : 1, 'armour-quality' : 4},
		'plate': {'defence' : 2, 'agility-modifier' : 2, 'armour-quality' : 5},
		'shiny-new-plate' : {'defence' : 3, 'agility-modifier' : 3, 'armour-quality' : 6},	
	}
...
class Combat(object):	
	...
	def __init__(self, hero, enemy, guards):
		...
		self.hero_penetration = hero.penetration	
		self.hero_defence = hero.defence
		self.hero_save = hero.save
