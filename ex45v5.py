...
class ManRat(Character):
	...
	def __init__(self):
		...
		# Claw attack
		self.weapon = BigBoy.attacks.get('claw-attack')
		self.dexterity = 4
		self.health = 20
		self.defence = 1
		self.agility = 4
	...
	def enter(self):		
		...
		if 'fight' in action:
			...
			if result:		
				...
				print "Out of the carnage emerges a beast of a man filled with such evil and hate that your very soul reals in horror..."
...
class Sewer(Scene):
	...
	def enter(self):
		...
		print "All the time you are aware of things moving around your feet... arrrgh rats! As you wade deeper and deeper through the foul stenching waters you become aware of a faint glimmer of light in the distance.. freedom, could it be?\n"
		print "You edge closer and closer towards the light and the darkness of the sewer is lifted ever so slightly... but just as you are within touching distance of what is seemingly the end, a large terrifying shriek is let out!\n"
		print "In front of you emerges a giant, fearsome beast. Half rat and half man, no doubt a result of the experiments conducted by the evil wizard that imprisoned you in this place!"
		print "Hope you still have that weapon of yours...\n"
...
class Exit(Scene):
	...
	def enter(self):
		print "With relief you reach the light beyond... a circular exit with 4 iron bars across it blocks your way. One of the bars appears to be rusted away, and you push it aside with what strength you have left."
		print "You crawl out into the fresh, crisp, cold air onto a marshy river bank. At last you are free! You can see the surrounding land stretches far and wide into the distance and you realise this is just the beginning of your journey."
		print "Who are you? What is your true identity? Why did the evil wizard imprison you within his castle? So many questions fill your head... but quick, you should get moving before any of the Wizard's minions try to follow you."
		print "With that you move swiftly onwards, ready to embrace what other perils await."
		print "\n*** END OF PART 1 *** \n"
